...
const Navbar = () => {
  ...
  <div className="navbar w-11/12 mx-auto bg-base-100 flex justify-between items-center shadow-sm">
    ...
    <div className="flex-1 flex justify-end items-center gap-2">
      ...
      <button className="btn btn-sm md:btn-md rounded-3xl bg-[linear-gradient(to_bottom,#4f39f6_0%,#9514fa_100%)] text-white border-none">
        Get Started
      </button>
    </div>
